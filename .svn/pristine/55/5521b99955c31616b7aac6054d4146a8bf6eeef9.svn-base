...
import com.msz.util.config.AutoGenerator;
...
//                        .setUsername( "axecn" )
                        .setUsername("root")
                        .setPassword("123456")
                        .setUrl("jdbc:mysql://192.168.0.98:3306/wanwantest?characterEncoding=utf8&useSSL=false")
        ).setStrategy(
                // 策略配置
                new StrategyConfig()
                        // .setCapitalMode(true)// 全局大写命名
                        // .setDbColumnUnderline(true)//全局下划线命名
                        /*.setTablePrefix( new String[]{ "yhpc_" } )// 此处可以修改为您的表前缀*/
...
//                         自定义实体，公共字段
                ...
                new PackageConfig()
                        // .setModuleName( "test" )
                        .setParent( "com.baicang.crm" )// 自定义包路径
