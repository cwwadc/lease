...
public class SFTPUtil {
    ...
    public static void main(String[] args) throws SftpException, IOException {
        SFTPUtil sftp = new SFTPUtil("root", "Axe.com@=20181136&", "120.77.179.74", 22);
        sftp.login();
        File file = new File("E:\\ChromeCoreDownloads\\123.jpg");
        InputStream is = new FileInputStream(file);

        sftp.upload("/root","/upload", "test_sftp.jpg", is);
        sftp.logout();
    }
}
